...
class ModuleSettingTest {
    ...
    fun enable() {
        ...
        println(CF4M.module.getByInstance(this).setting.getByName("setting1").getSetting<EnableSettingTest>())
        for (settingProvider in CF4M.module.getByInstance(this).setting.all) {
