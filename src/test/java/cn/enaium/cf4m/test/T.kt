...
class T {
    ...
    fun test() {
        ...
        CF4M.instance.module.onKey(1)
        CF4M.instance.module.onKey(1)
        println("Check ModuleEnableDisableTest End")
        println()
        println("Check ModuleExtendTest Start")
        CF4M.instance.module.onKey(2)
        CF4M.instance.module.onKey(2)
        println("Check ModuleExtendTest1 End")
        println()
        CF4M.instance.module.onKey(3)
        CF4M.instance.module.onKey(3)
        println("Check ModuleExtendTest1 End")
        println()
        println("Check ModuleSettingTest Start")
        CF4M.instance.module.onKey(4)
        println("Check ModuleSettingTest End")
        println()
        println("Check CommandTest Start")
        println(CF4M.instance.command.execCommand("`t"))
        println(CF4M.instance.command.execCommand("`t var1"))
        println(CF4M.instance.command.execCommand("`t var1 1"))
